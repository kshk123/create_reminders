...
def _parse_due(iso_value: str):
    ...
    try:
        ...
        # Use unambiguous format: "8 January 2025 10:00" - works across locales
...
class Handler(BaseHTTPRequestHandler):
    ...
    def do_GET(self):
        # Token endpoint - allows extension to fetch current token directly
        if self.path == "/token":
            self._send(200, {"auth_token": AUTH_TOKEN})
            return
